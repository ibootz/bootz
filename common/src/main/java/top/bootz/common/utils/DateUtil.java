...
public final class DateUtil {
	...
	public static String date2str(Date date) {
		...
		return new SimpleDateFormat(BasePatternConstants.DATE_FORMAT_PATTERN_1).format(date);
	}
	...
	public static Date str2date(String str) {
		...
		Date date = null;
		try {
			date = new SimpleDateFormat(BasePatternConstants.DATE_FORMAT_PATTERN_1).parse(str);
