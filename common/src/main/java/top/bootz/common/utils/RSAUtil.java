...
public class RSAUtil {
	 ...
	 * 公钥文件存储路径
	 */
	private static final String PUBLIC_KEY_FILE_PATH = getBaseClassPath() + BaseSecurityConstants.PUBLIC_KEY_FILE_PATH;

	/**
	 * 私钥文件存储路径
	 */
	private static final String PRIVATE_KEY_FILE_PATH = getBaseClassPath() + BaseSecurityConstants.PRIVATE_KEY_FILE_PATH;
	...
	private static void writeToFile(String publicKeyStr, String filePath) throws IOException {
		FileUtils.write(new File(filePath), publicKeyStr, BaseAppConstants.CHARSET_UTF_8);
	}
